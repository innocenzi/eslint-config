	...
	return [
		{
			...
			name: 'innocenzi/typescript/setup',
			plugins: {
				antfu: pluginAntfu,
				ts: pluginTs as any,
			},
		...
		{
			files,
			name: 'innocenzi/typescript/rules',
			rules: {
				...renameRules(
		...
		...isTypeAware
			? [{
					...
					name: 'innocenzi/typescript/rules-type-aware',
					rules: {
		...
		{
			files: ['**/*.d.ts'],
			name: 'innocenzi/typescript/disables/dts',
			rules: {
		...
		},
		{
			...
			name: 'innocenzi/typescript/disables/test',
			rules: {
		...
		{
			files: ['**/*.js', '**/*.cjs'],
			name: 'innocenzi/typescript/disables/cjs',
			rules: {
